...
class DefaultController extends Controller
{
     ...
     public function setVoteUp($id)
    {
        if (!$this->get('session')->has("votedup".$id) && !$this->get('session')->has("voteddown".$id)){
            ...
            $this->get('session')->set("voteddup" . $id, "yes");
     ...
     */
    public function canEdit(Request $request, $id)
    {
        ...
        return $this->render('edit.html.twig', array('fortune' => $byId, 'form' => $form->createView()));
    }
